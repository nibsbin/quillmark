...
impl QuillConfig {
    ...
    /// Parse QuillConfig from YAML content and collect non-fatal warnings.
...
"#;
    ...
    #[test]
    fn test_quill_config_from_yaml_with_warnings_collects_invalid_fields() {
        let yaml_content = r#"
Quill:
  name: test-warnings
  version: "1.0"
...
"#;
        ...
        assert!(!config.document.fields.contains_key("invalid_field"));
        ...
        assert!(warnings[0]
            .message
            .contains("Failed to parse field schema 'invalid_field'"));
    }
