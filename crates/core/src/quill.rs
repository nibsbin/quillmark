...
pub struct Quill {
    ...
    pub backend: String,
    /// Plate template content (optional) - the "printing plate" for rendering prints
...
pub struct QuillConfig {
    ...
    /// Plate file - the template used to render prints
...
"#;
    ...
    fn test_from_json() {
        ...
        assert!(quill.plate.unwrap().contains("Test Glue"));
        assert!(quill.metadata.contains_key("backend"));
    }
    ...
    fn test_from_json_with_byte_array() {
        ...
        // Byte array encodes: [Quill]\nname = "test"\nbackend = "typst"\nplate_file = "plate.typ"\ndescription = "Test quill"\n
        let json_str = r#"{
            "files": {
                "Quill.toml": {
                    "contents": [91, 81, 117, 105, 108, 108, 93, 10, 110, 97, 109, 101, 32, 61, 32, 34, 116, 101, 115, 116, 34, 10, 98, 97, 99, 107, 101, 110, 100, 32, 61, 32, 34, 116, 121, 112, 115, 116, 34, 10, 112, 108, 97, 116, 101, 95, 102, 105, 108, 101, 32, 61, 32, 34, 112, 108, 97, 116, 101, 46, 116, 121, 112, 34, 10, 100, 101, 115, 99, 114, 105, 112, 116, 105, 111, 110, 32, 61, 32, 34, 84, 101, 115, 116, 32, 113, 117, 105, 108, 108, 34, 10]
                },
                "plate.typ": {
                    "contents": "test plate"
                }
