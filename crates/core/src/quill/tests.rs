...
fn check_schema_snapshot(
    ...
    let quill = load_from_path(quillmark_fixtures::resource_path("quills/usaf_memo/0.3.0"))
        .expect("load usaf_memo fixture");
    let yaml = yaml_of(&quill.config);
    let golden_path =
        quillmark_fixtures::resource_path(&format!("quills/usaf_memo/0.3.0/__golden__/{golden}"));
...
#[test]
fn schema_snapshot_usaf_memo_0_3_0() {
