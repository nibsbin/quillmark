...
fn test_with_font_collision() {
    ...
    let result = workflow.with_font("custom.ttf", vec![4, 5, 6]);
    assert!(matches!(
        result,
...
fn test_with_font_and_asset_together() {
    ...
    let workflow = workflow
        ...
        .with_font("custom.ttf", vec![4, 5, 6])
        .expect("Should add font");
