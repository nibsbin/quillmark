...
fn test_usaf_form_8_fields() {
    let form_path = concat!(env!("CARGO_MANIFEST_DIR"), "/../quillmark-fixtures/resources/usaf_form_8/form.pdf");
...
fn test_backend_compilation() {
    ...
    let quill_path = concat!(env!("CARGO_MANIFEST_DIR"), "/../quillmark-fixtures/resources/usaf_form_8");
